---
name: ado-client
description: Azure DevOps REST API utility. Provides curl patterns for work items (read, create, update, comment, attachments). Referenced by /rt-fix, /taxone-fix and other ADO-integrated skills. NOT user-invocable.
---

# ADO Client — Azure DevOps REST API Reference

Utility skill for interacting with Azure DevOps. Not invoked directly — referenced by skills like `/rt-fix` and `/taxone-fix`.
